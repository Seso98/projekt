			...
			<table>
				...
				while($row = @mysqli_fetch_array($result)) {
					...
					<tr>
						...
						<td><a href="index.php?menu='.$menu.'&amp;action='.$action.'&amp;edit=' .$row['id']. '"><img src="slike/edit.png" alt="uredi"></a></td>
						<td><a href="index.php?menu='.$menu.'&amp;action='.$action.'&amp;delete=' .$row['id']. '"><img src="slike/delete.png" alt="obriši"></a></td>
						<td>' . $row['title'] . '</td>
						<td>';
