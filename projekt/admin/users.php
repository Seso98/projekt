		...
		<div id="users">
			<table>
				...
				while($row = @mysqli_fetch_array($result)) {
					print '
					<tr>
						<td><a href="index.php?menu='.$menu.'&amp;action='.$action.'&amp;id=' .$row['id']. '"><img src="slike/user.png" alt="user"></a></td>
						<td>';
							if ($_SESSION['user']['role'] == 1 || $_SESSION['user']['role'] == 2) {
								print '<a href="index.php?menu='.$menu.'&amp;action='.$action.'&amp;edit=' .$row['id']. '"><img src="slike/edit.png" alt="uredi"></a></td>';
							}
						print '
						<td>';
							if ($_SESSION['user']['role'] == 1 || $_SESSION['user']['role'] == 2) {
								print '<a href="index.php?menu='.$menu.'&amp;action='.$action.'&amp;delete=' .$row['id']. '"><img src="slike/delete.png" alt="obriši"></a>';
							}
						print '	
						</td>
						...
						<td>';
							if ($row['archive'] == 'Y') { print '<img src="slike/inactive.png" alt="" title="" />'; }
                            else if ($row['archive'] == 'N') { print '<img src="slike/active.png" alt="" title="" />'; }
						print '
						</td>
					</tr>';
				}
